...
"""Tests for sequential questionnaire engine."""
...
class SequentialQuestionnaireEngineTest(absltest.TestCase):

  def test_next_acting_parses_names_and_filters_unknown(self):
    engine = sequential_questionnaire.SequentialQuestionnaireEngine()
    ...
    with mock.patch.object(sequential_questionnaire.logging, 'warning') as warn:
