...
r"""Run general store simulations with opensource language models.
...
_SCENARIO_MODULES = [
    scenario_00_crime_and_punishment,
]
...
def main():
  parser = argparse.ArgumentParser(
      description="Run Concordia general store simulations."
  )
  parser.add_argument(
      "--scenario",
      type=int,
  ...
  parser.add_argument(
      "--output_dir",
      type=str,
      default=os.path.expanduser("~/general_store_results"),
