...
_FAILED_TO_REPEL_BARBARIAN_RAID_EVENT_DESCRIPTIONS = (
    (
        'The barbarian invasion could not be stopped. Untrained and'
        ' ill-prepared for the ferocity of the assault, the defenders were'
        ' swiftly overcome. Barbarians overrun the region, taking whatever they'
        ' please. After a season of terror they finally leave, but not because'
        ' they were driven out, but rather because precious little worth'
        ' plundering remained. The wanton cruelty of the barbarians caused much'
    ...
    (
        ...
        ' Farms were razed, crops destroyed, and countless innocents were taken'
        ' as slaves. The devastating incursion left scars both physical and'
        ' emotional on the populace.'
    ),
    (
...
_FAILED_TO_GROW_ENOUGH_FOOD_EVENT_DESCRIPTIONS = (
    (
        'The crops failed due lack of time spent on farm work, and the'
        ' villagers face a harsh winter of scarcity.'
    ),
    (
    ...
    (
        ...
        ' tightened. The villagers, having spent their time on matters other'
        ' than cultivation, now face the bitter consequences of their neglect.'
    ),
    (
...
_SUCCEEDED_TO_GROW_ENOUGH_FOOD_EVENT_DESCRIPTIONS = (
    ...
    (
        ...
        ' bountiful harvest. The villagers rejoiced, their granaries'
        ' overflowing with the fruits of their labor.'
    ),
    (
        'Through tireless effort and unwavering dedication, the villagers'
        ' coaxed forth an abundance from the earth. Their larders are full, and'
        " their hearts filled with gratitude for the land's generous bounty."
    ),
    (
        'The sun shone warmly upon the fertile fields, and the rains fell'
        ' gently upon the burgeoning crops. The villagers, ever mindful of'
        ' their agricultural duties, reaped a harvest that would sustain them'
        ' through even the harshest winter.'
    ),
    (
...
def sample_parameters(
  ...
  shuffled_village_names = list(rng.sample(VILLAGE_NAMES, len(VILLAGE_NAMES)))
