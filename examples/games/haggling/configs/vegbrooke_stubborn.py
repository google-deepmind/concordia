...
"""Vegbrooke stubborn merchant configuration.

In this scenario, there is one supporting player who will only transact at
exactly 4 coins - rejecting both higher and lower offers.
"""
...
SUPPORTING_PLAYER_MEMORIES = [
    "{name} is a stubborn merchant. {name} will sell items exactly for 4 "
    "coins, no more and no less. {name} is very vocal about it."
]
