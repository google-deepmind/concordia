...
"""Fruitville gullible configuration.

In this scenario, there is one supporting player who will accept any offer
and always propose 3 coins. This tests whether agents can exploit a naive
trading partner.
"""
...
SUPPORTING_PLAYER_MEMORIES = [
    ...
    "{name} is very vocal about it and will not haggle and will praise any "
    "offer."
]
