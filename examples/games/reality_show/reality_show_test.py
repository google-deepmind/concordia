...
"""Holistic tests for reality_show using puppet agents."""

from absl.testing import absltest
from examples.games.reality_show import simulation
from examples.games.reality_show.configs import puppet as puppet_config
...
class RealityShowTest(absltest.TestCase):
