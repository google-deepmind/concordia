...
"""Vegbrooke configuration for multi-item haggling simulation.

Vegetable-themed market scenario.
Migrated from:
concordia.examples.deprecated.modular.environment.modules.vegbrooke_haggling_multi_fruit
"""
...
LOCATION = "Vegbrooke"
EVENT = "The seasonal vegetable market"
