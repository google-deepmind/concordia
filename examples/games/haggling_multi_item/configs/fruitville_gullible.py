...
"""Fruitville gullible config: multi-item haggling with supporting player.

Migrated from:
concordia.examples.deprecated.modular.environment.modules.fruitville_haggling_multi_fruit_gullible
"""
...
ITEMS_FOR_SALE = ("apple", "banana", "pear")
PRICES = (1, 2, 3, 4, 5, 6)
...
SHARED_MEMORIES = [
    ...
    (
        ...
        "is really cheap and 6 coins is really expensive. The smallest value "
...
SUPPORTING_PLAYER_MEMORIES = [
    "{name} does not care about the price. {name} will accept any offer! "
